...
@Slf4j
@PluginDescriptor(
	name = "Trailblaizer achievement jingle",
	description = "The Leagues II: Trailblazer jingle plays when you complete an achievement",
	tags = {"leagues", "trailblazer", "collection log", "stats", "levels", "quests", "diary", "announce"}
)
...
public class JinglePlugin extends Plugin
{
	...
	@Provides
	JingleConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(JingleConfig.class);
	}
}
